...
<body>
    <div>
        ...
        <div style="border-color: #2A5099; border-style: double; border-width: 3px; margin: 0 auto;
            min-height: 400px; position: relative; width: 960px; height:960px; z-index: 1; background: #ffffff url('/images/Brands.png') no-repeat right top;">
           <select id="languages" style="float: right; margin-right: 10px; margin-top: 10px;">
            ...
            <img id="btnDetalle" data-method="ReadBrands" class="btnDetalle" style="margin-left: 263px; cursor:pointer;
